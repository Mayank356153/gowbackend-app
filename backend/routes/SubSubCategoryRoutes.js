...
const {assignMasterImageForSubSubCategory}=require("../controllers/itemController")
...
router.put("/assign/master-image" ,authMiddleware,
  hasPermission("SubSubCategories", "Update"),assignMasterImageForSubSubCategory)
