...
const SalesReturnSchema = new mongoose.Schema(
  {
    ...
    sale:       { type: mongoose.Schema.Types.ObjectId, required: true, refPath: "saleModel" },
   saleModel:  { type: String, enum: ["Sales", "PosOrder"], required: true },
    returnCode: { type: String, required: true },
    referenceNo: { type: String, default: "" }, // New field for reference number
  ...
  discountOnAll: { type: Number, default: 0 },
    ...
    // Track who created the return using dynamic references
    createdBy: {
      type: mongoose.Schema.Types.ObjectId,
