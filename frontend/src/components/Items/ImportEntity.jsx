    ...
    reader.onload = async (evt) => {
      try {
        ...
        const payload = rows.map((r) => {
          ...
          if (entity === "sub-subcategories") {
            const names = String(r.images || "").split(/;|,/).map((s) => s.trim()).filter(Boolean);
    ...
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      <div className="flex flex-grow md:flex-row">
        ...
        <main className="flex-1 p-6 overflow-y-auto lg:p-8">
          <header className="flex flex-col items-start justify-between mb-6 md:flex-row md:items-center">
            <div>
          ...
          {mode === "single" ? (
            <form
              ...
              className="max-w-2xl p-6 mx-auto bg-white border border-gray-200 shadow-sm rounded-xl"
            >
                ...
                {entity !== "sub-subcategories" ? (
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 transition-colors border border-gray-300 rounded-lg file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100"
                    />
                    {form.image && (
                      <div className="mt-3">
                        <img
                      ...
                      <div className="grid grid-cols-2 gap-3 mt-3 sm:grid-cols-3">
                        {form.images.split(';').map((fn) => (
                          <div key={fn} className="relative">
                            <img
                              src={`/vps/uploads/subsubcategory/${fn}`}
                              className="object-cover w-24 h-24 border border-gray-200 rounded-lg"
                              alt=""
                            />
                            <button
                              ...
                              className="absolute p-1 text-white transition-colors bg-red-500 rounded-full top-1 right-1 hover:bg-red-600"
                              title="Remove image"
                            >
                              <svg
                                className="w-4 h-4"
              ...
              <div className="flex justify-end mt-6">
                <button
                  type="submit"
                  className="px-6 py-2 font-medium text-white transition-colors bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                >
                ...
                <div>
                  ...
                  <div className="p-4 border border-gray-200 rounded-lg bg-gray-50">
                    ...
                    <button
                      ...
                      className="inline-flex items-center px-3 py-1 mt-2 text-sm font-medium text-blue-700 transition-colors bg-blue-100 rounded-lg hover:bg-blue-200"
                    >
