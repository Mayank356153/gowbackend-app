    ...
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-grow">
        ...
        <div className="flex flex-col flex-1 p-4">
          {/* Title + Breadcrumb */}
          <header className="flex items-center justify-between px-2 py-2 mb-4 bg-gray-100 rounded shadow">
          ...
          {/* Controls */}
          <div className="flex flex-col justify-between gap-2 mb-0 md:flex-row md:items-center">
            <div className="flex items-center gap-2">
              <span>Show</span>
              <select
                ...
                {current.length === 0 ? (
                  ...
                  current.map((u, i) => (
                    <tr key={u._id} className="text-sm">
                      ...
                      >
                        {u.status === "active" ? (
                          <span className="px-2 py-1 text-white bg-green-500 rounded-full">Active</span>
                        ) : (
                          <span className="px-2 py-1 text-white bg-red-600 rounded-full">Inactive</span>
                        )}
                      </td>
                      <td className="p-2 border">
  <div>
    ...
    {actionMenu === u._id && (
      ...
      >
        <button
          className="w-full px-4 py-2 text-left text-gray-700 transition-colors duration-150 hover:bg-blue-50 hover:text-blue-600"
          onClick={(e) => {
            e.stopPropagation();
            setActionMenu(null);
        ...
        <button
          className="w-full px-4 py-2 text-left text-red-600 transition-colors duration-150 hover:bg-red-50 hover:text-red-700"
          onClick={(e) => {
            e.stopPropagation();
            setActionMenu(null);
            deleteUser(u._id);
