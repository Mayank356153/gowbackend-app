...
import { Navigate, useNavigate, useParams, NavLink,Link } from "react-router-dom";
    ...
    <div className="flex flex-col h-screen bg-gray-100">
      ...
      <div className="flex flex-grow">
        ...
        <div className="flex-grow w-full p-4 transition-all duration-300">
          ...
          <nav className="flex items-center mb-4 text-xs text-gray-500">
            <NavLink
              to="/dashboard"
              className="flex items-center text-gray-600 no-underline hover:text-gray-800"
            >
              <FaTachometerAlt className="mr-2" /> Home
            </NavLink>
            <NavLink
              to="/country-list"
              className="flex items-center mx-2 text-gray-600 no-underline hover:text-gray-800"
            >
