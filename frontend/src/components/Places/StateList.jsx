  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-grow">
        ...
        <div className="w-full p-4 overflow-x-auto transition-all duration-300">
          {/* header & breadcrumbs */}
          <header className="flex justify-between p-4 mb-2 bg-gray-100 rounded shadow">
            ...
            <nav className="flex items-center text-xs text-gray-500">
              <NavLink to="/dashboard" className="flex items-center text-gray-600 no-underline hover:text-gray-800">
          ...
          <div className="p-4 bg-white border-t-4 rounded shadow border-cyan-500">
            ...
            <div className="flex flex-wrap justify-between gap-2 mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                <button onClick={handleCopy} className="px-2 py-1 text-white rounded bg-cyan-500">Copy</button>
                <button onClick={handleExcelDownload} className="px-2 py-1 text-white rounded bg-cyan-500">Excel</button>
                <button onClick={handlePdfDownload} className="px-2 py-1 text-white rounded bg-cyan-500">PDF</button>
                <button onClick={handlePrint} className="px-2 py-1 text-white rounded bg-cyan-500">Print</button>
                <button onClick={handleCsvDownload} className="px-2 py-1 text-white rounded bg-cyan-500">CSV</button>
                <input
                  type="text"
                  placeholder="Search"
                  className="p-1 border rounded"
                      ...
                      <tr key={state._id} className="border-b">
                        ...
                        <td className="px-4 py-2 border">
                          <button
                            ...
                            className="px-2 py-1 mr-2 text-white rounded bg-cyan-600"
                          >
                            Edit
                          </button>
                          <button
