      ...
      <div className="flex flex-grow bg-gray-200">
        ...
        <div className="w-full p-8 mx-auto bg-white">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              className="px-4 py-2 font-bold text-white transition-colors duration-200 bg-blue-500 rounded hover:bg-blue-600"
  ...
  <div>
    ...
    {actionMenu === store._id && (
      ...
      >
        ...
        <button
          className="w-full px-4 py-2 text-left text-blue-600 transition-colors duration-150 hover:bg-blue-50 hover:text-blue-700"
          onClick={(e) => {
            e.stopPropagation(); // Prevent event bubbling
            setActionMenu(null); // Close dropdown
