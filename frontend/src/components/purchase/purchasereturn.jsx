          ...
          <div className="relative mb-6">
            <div className="flex items-center">
              ...
              <button
                ...
                className="px-4 py-2 ml-2 text-white bg-green-600 rounded disabled:bg-gray-400"
              >
                Add
              </button>
              <button
                ...
                disabled={!selectedWarehouse}
                className="p-2 ml-2 bg-gray-100 rounded disabled:opacity-50"
              >
              ...
              {items.length === 0 ? (
                ...
                items.map((it, idx) => (
                  <tr key={idx}>
                    ...
                    <td className="p-2 border">{it.totalAmount.toFixed(2)}</td>
                    <td className="p-2 border">
