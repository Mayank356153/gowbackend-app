    ...
    const fetchData = async () => {
      try {
        ...
        const categoriesResponse = await axios.get(
          "https://mybackend-l7om.onrender.com/api/categories",
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="relative w-11/12 max-w-5xl p-6 bg-white rounded-lg shadow-lg">
          ...
          {currentMasterImage ? (
            <div className="flex flex-col items-center">
              <img  onClick={()=>handleSubmit(currentMasterImage)}
                src={`http://localhost:5000/${currentMasterImage}`} 
        ...
        <div className="flex flex-col justify-between gap-3 mt-6 md:flex-row">
          <button
