    ...
    >
      <table className='min-w-full border-2 divide-y divide-gray-200 min-h-48'>
        <thead className='sticky top-0 bg-gray-200'>
          <tr>
            <th className='py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase'>Item Id</th>
        ...
        <tbody className='bg-white divide-y divide-gray-200'>
          {itemsToShow.map((user, index) => (
            <tr key={index}>
              <td className='py-4 text-sm text-gray-500 whitespace-nowrap'>{user._id}</td>
