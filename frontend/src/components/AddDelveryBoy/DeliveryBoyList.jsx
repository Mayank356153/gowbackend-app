      ...
      <div className="flex flex-1 pt-16">
        ...
        >
          ...
          <div className="flex flex-col items-start justify-between gap-4 mb-6 sm:flex-row sm:items-center sm:gap-0">
            <h1 className="text-2xl font-bold text-center sm:text-3xl sm:text-left">Delivery Boys List</h1>
            <button
              onClick={handleAddDeliveryBoy}
              className="w-full px-4 py-2 text-sm font-bold text-white transition duration-300 bg-blue-600 rounded-lg sm:w-auto hover:bg-blue-700 sm:text-base"
            >
              Add Delivery Boy
            </button>
          </div>
          ...
          {loading && <p className="text-sm text-center text-gray-400 sm:text-base">Loading...</p>}
          {error && <p className="text-sm text-center text-red-400 sm:text-base">{error}</p>}
          ...
          {deliveryBoys.length > 0 ? (
            <>
              ...
              <div className="hidden overflow-x-auto sm:block">
                <table className="min-w-full bg-gray-800 rounded-lg shadow-md">
                  <thead>
                    <tr className="text-gray-200 bg-gray-700">
                  ...
                  <tbody>
                    {currentDeliveryBoys.map((boy) => (
                      <tr key={boy.id} className="text-center hover:bg-gray-600">
              ...
              <div className="block space-y-4 sm:hidden">
                {currentDeliveryBoys.map((boy) => (
                  <div key={boy.id} className="p-4 bg-gray-800 border border-gray-700 rounded-lg shadow-md">
            ...
            !loading && <p className="text-sm text-center text-gray-400 sm:text-base">No delivery boys found.</p>
          )}
        </div>
      </div>
    </div>
