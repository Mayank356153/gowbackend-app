        ...
        <div className="flex flex-col flex-grow p-2 md:p-2">
          ...
          <header className="flex flex-col items-center justify-between p-4 mb-2 bg-gray-100 rounded-md shadow sm:flex-row">
            <div className="flex items-baseline gap-1">
              <h1 className="text-lg font-semibold sm:text-xl">Units List</h1>
              <span className="text-xs text-gray-600 sm:text-sm">View / Search</span>
            </div>
            <nav className="flex items-center text-xs text-gray-500 sm:text-sm">
          ...
          <div className="p-4 bg-white border-t-4 rounded-lg shadow-md border-cyan-500">
            ...
            {/* controls */}
            <div className="flex flex-col gap-2 mb-4 lg:flex-row lg:items-center">
