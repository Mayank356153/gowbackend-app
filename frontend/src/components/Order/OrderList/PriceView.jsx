...
//         itemTax: ((itemSubtotal - itemDiscount) * ((order.tax || 0) / 100)),
//         finalPrice: itemSubtotal - itemDiscount + ((itemSubtotal - itemDiscount) * ((order.tax || 0) / 100)),
//       });
//     });

//     const totalTax = itemDetails.reduce((sum, item) => sum + item.itemTax, 0);
//     const grandTotal =
//       subtotal - totalDiscount + totalTax + (order.shippingFee || 0);
...
//       render: (_, record) => (
//         <div>
//           <div className="font-medium">{record.item?.itemName || 'Unnamed Item'}</div>
//         </div>
//       ),
//     },
//     {
