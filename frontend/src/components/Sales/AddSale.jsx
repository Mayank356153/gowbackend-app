  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-grow">
        ...
        <main className="flex flex-col flex-grow p-2 overflow-x-auto md:p-4">
          {/* breadcrumb */}
          <header className="flex flex-col p-2 mb-4 bg-gray-200 rounded-md sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="relative flex items-center mt-4">
            ...
            {query && suggestions.length > 0 && (
              <ul className="absolute z-50 w-full overflow-auto bg-white border rounded shadow top-11 max-h-64">
                {suggestions.map((s) => (
                  <li
                    key={s._id}
          ...
          <div className="mt-4 overflow-x-auto rounded">
            <table className="min-w-full border">
              <thead className="text-sm text-white bg-sky-600">
                <tr>
              ...
              <tbody>
                {items.length === 0 ? (
                  ...
                  items.map((it, i) => (
                    <tr
                      key={i}
                      className="text-sm text-center odd:bg-gray-50"
                    >
                      <td className="p-1 border">{it.itemName}</td>
                      <td className="p-1 border">{it.itemCode}</td>
          ...
          {prevPayments.length > 0 && (
            <div className="mt-6">
              <h2 className="mb-2 text-base font-semibold text-cyan-500">
                Previous Payments
              </h2>
                  ...
                  <tbody>
                    {prevPayments.map((p, i) => (
                      ...
                      >
                        ...
                        <td className="p-1 border">{p.paymentNote || "–"}</td>
                        <td className="p-1 border">
                          <Link
                            to={`/receipt/${editId}`}
          ...
          {/* payment entry */}
          <div className="p-4 mt-6 space-y-4 bg-gray-100 rounded-lg">
          ...
          <div className="flex justify-center gap-4 mt-6">
            <button
              className="px-10 py-2 text-white bg-green-600 rounded hover:bg-green-700"
              onClick={save}
            >
              {editId ? "Update" : "Save"}
            </button>
            <button
              className="px-10 py-2 text-white bg-orange-500 rounded hover:bg-orange-600"
          ...
          {scanning && (
            <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-black/70">
              <div className="relative overflow-hidden border-4 border-white w-72 h-72">
                <video
                  ref={videoRef}
