         ...
         <div className={`flex-grow flex flex-col p-2 md:p-2  `}>
          <header className="flex flex-col items-center justify-between p-4 rounded-md shadow sm:flex-row">
            <div className="flex items-center gap-1 text-center sm:flex-row sm:text-left">
              <h1 className="text-lg font-semibold truncate sm:text-xl">New </h1>
          ...
          <div className="p-4 mt-1 bg-white border-t-4 rounded-lg shadow-md border-cyan-500">
                 ...
                 <div className="flex gap-5">
                  <div className="w-full">
                    ...
                    <Select className="w-full" options={warehouseView} onChange={(option)=>setFormData((prev)=>({...prev,warehouseId:option.value}))}/>
                  </div>
                 </div>
                  ...
                  <div className="w-full">
                    ...
                    <input type="text" name="username" className='w-full px-2 py-2 border-2 rounded-md'  value={userData.employee} onChange={e=>setUserData((prev)=>({...prev,employeeCode:e.target.value}))}/>
                  </div>
