        ...
        >
          ...
          <div className="flex flex-col items-start justify-between gap-4 mb-6 sm:flex-row sm:items-center sm:gap-0">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-lg font-semibold text-gray-800 sm:text-xl">Booking Management / Orders</h1>
            </div>
          ...
          <div className="flex flex-col items-start justify-between gap-4 mb-4 sm:flex-row sm:items-center sm:gap-0">
            <button className="flex items-center w-full gap-2 px-4 py-2 text-gray-600 bg-white border rounded-md sm:w-auto">
          ...
          {!loading && (
            <div className="hidden overflow-x-auto sm:block">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="text-gray-800 bg-orange-100">
                        ...
                        {editingOrderId === order._id ? (
                          <div className="flex gap-2">
                            <button
                              ...
                              className="px-2 py-1 text-white bg-green-500 rounded hover:bg-green-600 disabled:opacity-50"
                              disabled={loading}
                            >
                              Save
                            </button>
                            <button
                              ...
                              className="px-2 py-1 text-white bg-gray-500 rounded hover:bg-gray-600 disabled:opacity-50"
                              disabled={loading}
                            >
                              Cancel
                            </button>
                          ...
                          <button
                            ...
                            className="px-2 py-1 text-white bg-blue-500 rounded hover:bg-blue-600 disabled:opacity-50"
                            disabled={loading}
                          >
                            Edit
                          </button>
              ...
              {currentOrders.map((order) => (
                <div key={order._id} className="p-4 bg-white border rounded-lg shadow-md">
                  <div className="flex flex-col gap-2">
                    <div>
                      <span className="text-sm font-semibold">Book Number: </span>
                      {editingOrderId === order._id ? renderField(order, 'bookNumber') : (
                        <Link to={`/order-details/${order._id}`} className="text-blue-600 no-underline">
                          {order.bookNumber}
                        </Link>
          ...
          {!loading && filteredOrders.length === 0 && (
            <div className="mt-6 text-center text-gray-600">No orders found.</div>
          )}
        </div>
      </div>
    </div>
