        ...
        <div className={`  flex flex-col  transition-all duration-300  p-2 w-full overflow-x-hidden `}>
          ...
          <div className='w-full mx-auto bg-white border-t-4 border-collapse rounded-lg shadow-md border-opacity-55 border-t-blue-600'>
            ...
            <div className='flex flex-col items-center justify-start px-3 py-2 sm:justify-between sm:flex-row'>
              ...
              <button className='flex-shrink-0 px-4 py-2 font-bold text-center text-white bg-blue-600 rounded cursor-pointer hover:bg-blue-700' onClick={()=>Navigate("/customer/add")}>
                  ...
                  <tbody className='border-gray-100 border-1'>
                    ...
                    {filteredData.slice((currentPage - 1)* entriesPerPage, currentPage * entriesPerPage).map((item, index) => (
                      <tr key={index}>
                        ...
                        {/* Responsive hidden columns */}
                        <td className='px-2 py-2 border-gray-100 border-1'>{item.address?item.address.locationLink:"No Location link"}</td>
                        <td className='px-4 py-2 border-gray-100 border-1'>{item.creditLimit}</td>
                        <td className='px-4 py-2 border-gray-100 border-1'>{item.previousDue}</td>
                        <td className='px-4 py-2 border-gray-100 border-1'>{item.salesReturnDue || 0}</td>
...

                    {
                      filteredData.length>0 &&(
                        ...
                        {/* <td className='hidden px-4 py-2 bg-gray-200 lg:table-cell'></td> */}
                        <td className='px-4 py-2 bg-gray-200 '></td>
                        <td className='px-4 py-2 bg-gray-200 '></td>
                      </tr>
                      )
