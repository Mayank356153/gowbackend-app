...
const BookingSlot = () => {
    ...
    return (
        <div>
            <div className="flex items-center justify-around mt-4 mb-6">
            ...
            <div className="max-w-3xl p-6 mx-auto mt-10 bg-white rounded-lg shadow-lg">
                <ToastContainer />
                <h2 className="mb-4 text-xl font-semibold text-gray-800">Choose Delivery Date</h2>
                <div className="grid grid-cols-3 gap-4 mb-6 sm:grid-cols-4 md:grid-cols-7">
                    {dates.map((d, index) => (
                        <button
                            key={index}
                            disabled={d.full}
                        ...
                        >
                            ...
                            {d.full && <span className="mt-1 text-xs text-red-500">Slot Full</span>}
                        </button>
                    ))}
                </div>
