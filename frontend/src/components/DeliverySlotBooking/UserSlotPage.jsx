...
const UserSlotPage = () => {
  ...
  return (
    <div className="max-w-4xl px-4 mx-auto mt-8">
      <h1 className="mb-6 text-3xl font-bold text-start">Order Summary</h1>

      <div className="mb-6">
        <h2 className="mb-3 text-xl font-semibold">Select Date</h2>
      ...
      <div className="mb-6">
        <h2 className="mb-3 text-xl font-semibold">Select Time Slot</h2>
      ...
      <div className="mb-6">
        <h2 className="mb-3 text-xl font-semibold">Or Instant Delivery</h2>
